...
CREATE TABLE IF NOT EXISTS pagamentos (
    ...
    status VARCHAR(20) NOT NULL CHECK (status IN ('PENDING','AUTHORIZED','PAID','CANCELED','REFUSED','REFUNDED')),
...
CREATE TABLE IF NOT EXISTS tickets (
    ...
    FOREIGN KEY (atribuido_a_id) REFERENCES users(id),
...
-- Tabela de comentarios de tickets
