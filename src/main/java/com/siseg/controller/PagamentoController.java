...
public class PagamentoController {
    ...
    public ResponseEntity<PagamentoResponseDTO> criarPagamento(@PathVariable Long pedidoId) {
        PagamentoResponseDTO response = pagamentoService.criarPagamento(pedidoId);
